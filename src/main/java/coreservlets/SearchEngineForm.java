 ...
 * This servlet first displays a textfield for the search query, then looks up the search
 * engine names known to SearchUtilities and displays a list of radio buttons, one for
 * each search engine.
 * <p>
...
public class SearchEngineForm
  ...
  private static final long serialVersionUID = -6964793865354733636L;
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    for (int i = 0; i < specs.length; i++) {
      ...
      out.println("<INPUT TYPE=\"RADIO\" " + "NAME=\"searchEngine\" "
                  + "VALUE=\""
                  + searchEngineName
                  + "\">\n");
