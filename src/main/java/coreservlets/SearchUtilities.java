...
public class SearchUtilities {
  private static SearchSpec[] commonSpecs = {
    ...
    new SearchSpec("HotBot", "http://hotbot.com/search/web?q="), };
   ...
   * that search engine for that query. Returns null if the search engine name is not one
   * of the ones it knows about.
   */
